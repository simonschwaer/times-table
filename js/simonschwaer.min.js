...
jQuery.fn[type]=function(fn){return this.on(type,fn)}}),jQuery.expr.filters.animated=function(elem){return jQuery.grep(jQuery.timers,function(fn){return elem===fn.elem}).length};var docElem=window.document.documentElement;jQuery.offset={setOffset:function(elem,options,i){var curPosition,curLeft,curCSSTop,curTop,curOffset,curCSSLeft,calculatePosition,position=jQuery.css(elem,"position"),curElem=jQuery(elem),props={};"static"===position&&(elem.style.position="relative"),curOffset=curElem.offset(),curCSSTop=jQuery.css(elem,"top"),curCSSLeft=jQuery.css(elem,"left"),calculatePosition=("absolute"===position||"fixed"===position)&&(curCSSTop+curCSSLeft).indexOf("auto")>-1,calculatePosition?(curPosition=curElem.position(),curTop=curPosition.top,curLeft=curPosition.left):(curTop=parseFloat(curCSSTop)||0,curLeft=parseFloat(curCSSLeft)||0),jQuery.isFunction(options)&&(options=options.call(elem,i,curOffset)),null!=options.top&&(props.top=options.top-curOffset.top+curTop),null!=options.left&&(props.left=options.left-curOffset.left+curLeft),"using"in options?options.using.call(elem,props):curElem.css(props)}},jQuery.fn.extend({offset:function(options){if(arguments.length)return void 0===options?this:this.each(function(i){jQuery.offset.setOffset(this,options,i)});var docElem,win,elem=this[0],box={top:0,left:0},doc=elem&&elem.ownerDocument;if(doc)return docElem=doc.documentElement,jQuery.contains(docElem,elem)?(typeof elem.getBoundingClientRect!==strundefined&&(box=elem.getBoundingClientRect()),win=getWindow(doc),{top:box.top+win.pageYOffset-docElem.clientTop,left:box.left+win.pageXOffset-docElem.clientLeft}):box},position:function(){if(this[0]){var offsetParent,offset,elem=this[0],parentOffset={top:0,left:0};return"fixed"===jQuery.css(elem,"position")?offset=elem.getBoundingClientRect():(offsetParent=this.offsetParent(),offset=this.offset(),jQuery.nodeName(offsetParent[0],"html")||(parentOffset=offsetParent.offset()),parentOffset.top+=jQuery.css(offsetParent[0],"borderTopWidth",!0),parentOffset.left+=jQuery.css(offsetParent[0],"borderLeftWidth",!0)),{top:offset.top-parentOffset.top-jQuery.css(elem,"marginTop",!0),left:offset.left-parentOffset.left-jQuery.css(elem,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var offsetParent=this.offsetParent||docElem;offsetParent&&!jQuery.nodeName(offsetParent,"html")&&"static"===jQuery.css(offsetParent,"position");)offsetParent=offsetParent.offsetParent;return offsetParent||docElem})}}),jQuery.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(method,prop){var top="pageYOffset"===prop;jQuery.fn[method]=function(val){return access(this,function(elem,method,val){var win=getWindow(elem);return void 0===val?win?win[prop]:elem[method]:void(win?win.scrollTo(top?window.pageXOffset:val,top?val:window.pageYOffset):elem[method]=val)},method,val,arguments.length,null)}}),jQuery.each(["top","left"],function(i,prop){jQuery.cssHooks[prop]=addGetHookIf(support.pixelPosition,function(elem,computed){return computed?(computed=curCSS(elem,prop),rnumnonpx.test(computed)?jQuery(elem).position()[prop]+"px":computed):void 0})}),jQuery.each({Height:"height",Width:"width"},function(name,type){jQuery.each({padding:"inner"+name,content:type,"":"outer"+name},function(defaultExtra,funcName){jQuery.fn[funcName]=function(margin,value){var chainable=arguments.length&&(defaultExtra||"boolean"!=typeof margin),extra=defaultExtra||(margin===!0||value===!0?"margin":"border");return access(this,function(elem,type,value){var doc;return jQuery.isWindow(elem)?elem.document.documentElement["client"+name]:9===elem.nodeType?(doc=elem.documentElement,Math.max(elem.body["scroll"+name],doc["scroll"+name],elem.body["offset"+name],doc["offset"+name],doc["client"+name])):void 0===value?jQuery.css(elem,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:void 0,chainable,null)}})}),jQuery.fn.size=function(){return this.length},jQuery.fn.andSelf=jQuery.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return jQuery});var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},typeof noGlobal===strundefined&&(window.jQuery=window.$=jQuery),jQuery}),"undefined"!=typeof module&&(module.exports=Rainbow),function($){"use strict";$.fn.timesTable=function(options){var defaultOptions={multiplier:2,modulo:200,radius:300,origin:{x:400,y:400},lineWidth:1,color:"#000000"};options=$.extend(defaultOptions,options);for(var $container=this,destination=[],coordinates=[],i=0;i<=options.modulo;i++){destination[i]=i*options.multiplier%options.modulo;var angle=2*i*Math.PI/options.modulo;coordinates[i]={x:options.origin.x+options.radius*Math.cos(angle),y:options.origin.y+options.radius*Math.sin(angle)}}var canvas=$container[0].getContext("2d");canvas.clearRect(0,0,$container.width(),$container.height());for(var k=0;k<=options.modulo;k++)canvas.beginPath(),canvas.lineWidth=""+options.lineWidth,canvas.strokeStyle=options.color,canvas.moveTo(coordinates[k].x,coordinates[k].y),canvas.lineTo(coordinates[Math.round(destination[k])].x,coordinates[Math.round(destination[k])].y),canvas.stroke();return this}}(jQuery),function($){"use strict";var resizeId,interval=!1,playing=!0,settingsOpen=!1,$canvas=!1,colorSets=[{primary:["53777A","D95B43","ECD078"],secondary:["542437","53777A","C02942"]},{primary:["E5DAE3","645468","556270"],secondary:["556270","033649","2E2633"]},{primary:["CDB380","036564","E8DDCB"],secondary:["031634","E8DDCB","033649"]},{primary:["CC333F","EDC951","6A4A3C"],secondary:["6A4A3C","00A0B0","EB6841"]},{primary:["351330","CC2A41","64908A"],secondary:["E8CAA4","424254","351330"]},{primary:["BFB35A","F2C45A","5E8C6A"],secondary:["5E8C6A","8C2318","BFB35A"]}],colorSet=colorSets[Math.floor(Math.random()*(colorSets.length-0))];$(document).ready(function(){drawCanvas(),draw(parseFloat($("#multiplier").val()),parseInt($("#modulo").val(),10)),$(window).resize(function(){clearTimeout(resizeId),resizeId=setTimeout(function(){drawCanvas(),draw(parseFloat($("#multiplier").val()),parseInt($("#modulo").val(),10),!playing)},100)}),$('[data-toggle="offcanvas"]').click(function(e){settingsOpen=!settingsOpen,$(".row-offcanvas").toggleClass("active"),$(".settings-open").fadeToggle(250),e.preventDefault()}),$('#settings input[type="text"]').change(function(){playing||draw(parseFloat($("#multiplier").val()),parseInt($("#modulo").val(),10),!0)}).focus(function(){playing&&interval&&clearInterval(interval)}).blur(function(){playing&&draw(parseFloat($("#multiplier").val()),parseInt($("#modulo").val(),10))}),$("#toggle").click(function(e){interval&&playing?(clearInterval(interval),playing=!1,$(this).html('<i class="icon-play"></i> Resume')):(draw(parseFloat($("#multiplier").val()),parseInt($("#modulo").val(),10)),playing=!0,$(this).html('<i class="icon-pause"></i> Pause')),e.preventDefault()}),$("body").mouseup(function(e){settingsOpen&&0===$(e.target).closest("#sidebar").length&&(settingsOpen=!settingsOpen,$(".row-offcanvas").toggleClass("active"),$(".settings-open").fadeToggle(250))})});var draw=function(multi,modulo,single){var primary=new Rainbow,secondary=new Rainbow;primary.setNumberRange(0,modulo),secondary.setNumberRange(0,modulo),primary.setSpectrum.apply(this,colorSet.primary),secondary.setSpectrum.apply(this,colorSet.secondary);var width=$("#stage").width(),height=$("#stage").height(),radius=height/2.5;height>width&&(radius=width/2.2);var origin={x:width/2,y:height/2};if("undefined"!=typeof single&&single)drawStep(multi,$canvas,primary,secondary,radius,origin,modulo);else{var i=multi;interval=setInterval(function(){drawStep(i,$canvas,primary,secondary,radius,origin,modulo),$("#multiplier").val(i),i=Math.round(100*(i+.01))/100,i>modulo&&(i=0)},30)}},drawStep=function(i,$canvas,primary,secondary,radius,origin,modulo){$canvas.timesTable({modulo:modulo,multiplier:i,color:"#"+primary.colourAt(i),radius:radius,origin:origin}),$("body").css("background-color","#"+secondary.colourAt(i)),$(".change-color").css("color","#"+primary.colourAt(i))},drawCanvas=function(){interval&&clearInterval(interval),$canvas=$("<canvas />",{id:"plouffe"}).attr({height:$("#stage").height(),width:$("#stage").width()}).text("Please get a browser that does not suck."),$("#stage").html($canvas)}}(jQuery);
//# sourceMappingURL=simonschwaer.map